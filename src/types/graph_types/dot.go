...
// Provide a bytes.Buffer like structure, which will indent when starting a newline.
...
// the following methods intercecpt the byte.Buffer writes and insert the indentation when starting a new line.
